...
namespace WebApplicationAPI.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        {
            return _service.GetProductsOutOfStock();
        }

        [HttpGet("Category_Names")]
        ...
        public List<Product> GetProductName(string name)
        {
            ...
            return _service.GetProductName(name);
        }
        [HttpGet("GetProductsByPriceRange")]
        public List<Product> GetProductsByPriceRange(double minPrice, double maxPrice)
        {
            return _service.GetProductsByPriceRange(minPrice, maxPrice);
        }
    }
}
